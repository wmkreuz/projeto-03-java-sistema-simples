...
public class InternalFrameToFront extends JPanel {
   private static final int FRAME_MAX = 2;
   ...
   private static final int IF_WIDTH = 250;
   private static final int IF_HEIGHT = 200;
   ...
   public InternalFrameToFront() {
      ...
      for (int i = 0; i < internalFrames.length; i++) {
         ...
         intFrame.setMaximizable(true); // maximize
         intFrame.setIconifiable(true); // set minimize
         intFrame.setClosable(true); // set closed
         intFrame.setResizable(true); // set resizable
      ...
      slider.addChangeListener(new ChangeListener() {
         public void stateChanged(ChangeEvent ce) {
            ...
            if (!slider.getValueIsAdjusting()) {
               ...
               JInternalFrame intFrame = internalFrames[value];
               if(intFrame.isVisible() == false) {
            	   intFrame.setVisible(true);
               }
        	   intFrame.toFront();               
            }
